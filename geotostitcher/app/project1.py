...
class geoto_stitcher:
    def __init__(self, top=None):
        ...
        self.configs_block.place(relx=0.029, rely=0.012, relheight=0.163
                , relwidth=0.942)
        ...
        self.select_project.place(relx=0.102, rely=0.444, height=33, width=113
                , bordermode='ignore')
        ...
        self.select_recording.place(relx=0.409, rely=0.444, height=33, width=133
                , bordermode='ignore')
        ...
        self.select_rec.place(relx=0.044, rely=0.345, height=31, width=120
                , bordermode='ignore')
...
class project:
    def __init__(self, top=None):
        ...
        self.select_prj = tk.Button(self.top)
        self.select_prj.place(relx=0.405, rely=0.9, height=33, width=73)
        self.select_prj.configure(activebackground="beige")
        self.select_prj.configure(borderwidth="2")
        self.select_prj.configure(compound='left')
        self.select_prj.configure(text='''Select''')
