...
#    Jul 23, 2023 12:45:35 AM +0545  platform: Linux
...
class geoto_stitcher:
    def __init__(self, top=None):
        ...
        self.select_project.configure(cursor="fleur")
        ...
        self.select_s17.configure(cursor="fleur")
        ...
        self.rec_num.configure(cursor="fleur")
...
class project:
    def __init__(self, top=None):
        ...
        self.select_prj.place(relx=0.405, rely=0.877, height=33, width=73)
