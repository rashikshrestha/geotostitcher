...
#    Oct 14, 2022 07:06:23 PM +0545  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.input_dir.configure(textvariable=self.input_dir)
        ...
        self.preprocess_block.place(relx=0.028, rely=0.223, relheight=0.12
                , relwidth=0.945)
        ...
        self.start_preprocess.place(relx=0.073, rely=0.4, height=31, width=80
                , bordermode='ignore')
        ...
        self.auto_fill.place(relx=0.854, rely=0.933, height=31, width=80)
        ...
        self.process_pgf_2 = ttk.Progressbar(self.process_jpg_block)
        self.process_pgf_2.place(relx=0.554, rely=0.248, relwidth=0.41
                , relheight=0.0, height=19, bordermode='ignore')
        self.process_pgf_2.configure(length="281")

        self.start_process_pgf_2 = ttk.Button(self.process_jpg_block)
        self.start_process_pgf_2.place(relx=0.073, rely=0.59, height=31, width=80
                , bordermode='ignore')
        self.start_process_pgf_2.configure(command=project1_support.start_process_pgf)
        self.start_process_pgf_2.configure(takefocus="")
        self.start_process_pgf_2.configure(text='''Start''')
        self.start_process_pgf_2.configure(compound='left')
        ...
        self.process_pgf_rec_2 = tk.Label(self.process_jpg_block)
        self.process_pgf_rec_2.place(relx=0.783, rely=0.453, height=24, width=69
                , bordermode='ignore')
        self.process_pgf_rec_2.configure(activebackground="#f9f9f9")
        self.process_pgf_rec_2.configure(anchor='w')
        self.process_pgf_rec_2.configure(compound='left')
        self.process_pgf_rec_2.configure(text='''0''')
        ...
        self.process_pgf_status_2 = tk.Label(self.process_jpg_block)
        self.process_pgf_status_2.place(relx=0.72, rely=0.684, height=23
                , width=149, bordermode='ignore')
        self.process_pgf_status_2.configure(activebackground="#f9f9f9")
        self.process_pgf_status_2.configure(anchor='w')
        self.process_pgf_status_2.configure(compound='left')
        self.process_pgf_status_2.configure(text='''None''')
        ...
        self.pgf_label_2 = tk.Label(self.process_jpg_block)
        self.pgf_label_2.place(relx=0.029, rely=0.248, height=30, width=130
                , bordermode='ignore')
        self.pgf_label_2.configure(activebackground="#f9f9f9")
        self.pgf_label_2.configure(anchor='w')
        self.pgf_label_2.configure(compound='left')
        self.pgf_label_2.configure(text='''No of Threads''')

        self.process_jpg_block_1 = tk.LabelFrame(self.top)
        self.process_jpg_block_1.place(relx=0.028, rely=0.707, relheight=0.168
                , relwidth=0.945)
        self.process_jpg_block_1.configure(relief='groove')
        self.process_jpg_block_1.configure(text='''Stitch 360''')

        self.process_pgf_2_1 = ttk.Progressbar(self.process_jpg_block_1)
        self.process_pgf_2_1.place(relx=0.554, rely=0.254, relwidth=0.41
                , relheight=0.0, height=19, bordermode='ignore')
        self.process_pgf_2_1.configure(length="281")

        self.start_process_pgf_2_1 = ttk.Button(self.process_jpg_block_1)
        self.start_process_pgf_2_1.place(relx=0.073, rely=0.587, height=31
                , width=80, bordermode='ignore')
        self.start_process_pgf_2_1.configure(command=project1_support.start_process_pgf)
        self.start_process_pgf_2_1.configure(takefocus="")
        self.start_process_pgf_2_1.configure(text='''Start''')
        self.start_process_pgf_2_1.configure(compound='left')

        self.Label5_2_1 = tk.Label(self.process_jpg_block_1)
        ...
        self.process_pgf_rec_2_1 = tk.Label(self.process_jpg_block_1)
        self.process_pgf_rec_2_1.place(relx=0.783, rely=0.452, height=26
                , width=69, bordermode='ignore')
        self.process_pgf_rec_2_1.configure(activebackground="#f9f9f9")
        self.process_pgf_rec_2_1.configure(anchor='w')
        self.process_pgf_rec_2_1.configure(compound='left')
        self.process_pgf_rec_2_1.configure(text='''0''')

        self.Label7_2_1 = tk.Label(self.process_jpg_block_1)
        ...
        self.process_pgf_status_2_1 = tk.Label(self.process_jpg_block_1)
        self.process_pgf_status_2_1.place(relx=0.72, rely=0.683, height=25
                , width=149, bordermode='ignore')
        self.process_pgf_status_2_1.configure(activebackground="#f9f9f9")
        self.process_pgf_status_2_1.configure(anchor='w')
        self.process_pgf_status_2_1.configure(compound='left')
        self.process_pgf_status_2_1.configure(text='''None''')

        self.jpg_threads_1 = tk.Spinbox(self.process_jpg_block_1, from_=1.0, to=100.0)
        self.jpg_threads_1.place(relx=0.219, rely=0.254, relheight=0.214
                , relwidth=0.118, bordermode='ignore')
        self.jpg_threads_1.configure(activebackground="#f9f9f9")
        self.jpg_threads_1.configure(background="white")
        self.jpg_threads_1.configure(font="TkDefaultFont")
        self.jpg_threads_1.configure(highlightbackground="black")
        self.jpg_threads_1.configure(selectbackground="#c4c4c4")
        self.value_list = ['100',]
        self.jpg_threads_1.configure(values=self.value_list)

        self.pgf_label_2_1 = tk.Label(self.process_jpg_block_1)
        self.pgf_label_2_1.place(relx=0.029, rely=0.254, height=32, width=130
                , bordermode='ignore')
        self.pgf_label_2_1.configure(activebackground="#f9f9f9")
        self.pgf_label_2_1.configure(anchor='w')
        self.pgf_label_2_1.configure(compound='left')
        self.pgf_label_2_1.configure(text='''No of Threads''')
