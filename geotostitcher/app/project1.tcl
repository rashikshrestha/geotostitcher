...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 726x827+688+125
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    place $site_3_0.rad47 \
        -in $site_3_0 -x 0 -relx 0.088 -y 0 -rely 0.437 -width 0 \
        -relwidth 0.099 -height 0 -relheight 0.17 -anchor nw \
        -bordermode ignore 
    place $site_3_0.rad48 \
        -in $site_3_0 -x 0 -relx 0.088 -y 0 -rely 0.578 -width 0 \
        -relwidth 0.098 -height 0 -relheight 0.17 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab47 \
        -in $site_3_0 -x 0 -relx 0.629 -y 0 -rely 0.222 -width 0 \
        -relwidth 0.101 -height 0 -relheight 0.133 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab48 \
        -in $site_3_0 -x 0 -relx 0.746 -y 0 -rely 0.222 -width 0 \
        -relwidth 0.161 -height 0 -relheight 0.126 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab49 \
        -in $site_3_0 -x 0 -relx 0.629 -y 0 -rely 0.519 -width 0 \
        -relwidth 0.117 -height 0 -relheight 0.193 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.759 -y 0 -rely 0.548 -width 0 \
        -relwidth 0.086 -height 0 -relheight 0.119 -anchor nw \
        -bordermode ignore 
...
### SPOT dump_widget_opt A
    ...
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button "$site_3_0.tBu73" \
        -command "start_stitch_360" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$site_3_0.tBu47" \
        -command "generate_ptsstart_stitch_360low" -takefocus {} \
        -text "Start" -compound left 
...
proc vTclWindow.top2 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 600x431+1008+592
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top3 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 370x422+306+315
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
