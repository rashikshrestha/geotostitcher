...
#  Jul 22, 2023 07:24:29 PM EET  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 726x827+638+140
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    button "$site_3_0.but55" \
        ...
        -highlightcolor black -text "Select Project" 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but56" \
        ...
        -background $vTcl(actual_gui_bg) -borderwidth 2 -compound left \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -text "Select Recording" 
...
### SPOT dump_widget_opt A
    ...
    place $site_3_0.but55 \
        -in $site_3_0 -x 0 -relx 0.102 -y 0 -rely 0.444 -width 113 \
        -relwidth 0 -height 33 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but56 \
        -in $site_3_0 -x 0 -relx 0.409 -y 0 -rely 0.444 -width 133 \
        -relwidth 0 -height 33 -relheight 0 -anchor nw -bordermode ignore 
...
### SPOT dump_widget_opt A
    ...
    place $site_3_0.tBu47 \
        -in $site_3_0 -x 0 -relx 0.044 -y 0 -rely 0.345 -width 120 \
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.tLa51 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.012 -width 0 -relwidth 0.942 \
...
proc vTclWindow.top2 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 600x431+1128+450
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    button "$top.but54" \
        ...
        -background $vTcl(actual_gui_bg) -borderwidth 2 -compound left \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -text "Select" 
    vTcl:DefineAlias "$top.but54" "select_prj" vTcl:WidgetProc "project" 1
### SPOT dump_widget_opt A
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.but54 \
        -in $top -x 0 -relx 0.405 -y 0 -rely 0.9 -width 73 -relwidth 0 \
