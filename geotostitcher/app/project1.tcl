...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 726x827+537+73
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    button "$site_3_0.but55" \
        ...
        -command "select_project" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
        -text "Select Project" 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but56" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 \
        -command "select_recording" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black \
...
### SPOT dump_widget_opt A
    radiobutton "$site_3_0.rad47" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -anchor w -background $vTcl(actual_gui_bg) -command "select_s17" \
        -compound left -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -selectcolor #d9d9d9 -text "s17" \
...
### SPOT dump_widget_opt A
    radiobutton "$site_3_0.rad48" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -anchor w -background $vTcl(actual_gui_bg) -command "select_s18" \
        -compound left -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -selectcolor #d9d9d9 -text "s18" \
...
### SPOT dump_widget_opt A
    radiobutton "$site_3_0.rad49" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -anchor w -background $vTcl(actual_gui_bg) -command "select_s16" \
        -compound left -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -selectcolor #d9d9d9 -text "s16" \
        -value "0" -variable "selectedButton" 
...
### SPOT dump_widget_opt A
    ...
    place $site_3_0.rad47 \
        -in $site_3_0 -x 0 -relx 0.088 -y 0 -rely 0.593 -width 0 \
        -relwidth 0.099 -height 0 -relheight 0.17 -anchor nw \
        -bordermode ignore 
    place $site_3_0.rad48 \
        -in $site_3_0 -x 0 -relx 0.088 -y 0 -rely 0.741 -width 0 \
    ...
    place $site_3_0.rad49 \
        -in $site_3_0 -x 0 -relx 0.088 -y 0 -rely 0.444 -width 0 \
        -relwidth 0.098 -height 0 -relheight 0.17 -anchor nw \
        -bordermode ignore 
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$site_3_0.tBu61" \
        -command "start_preprocess" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$site_3_0.tBu73" \
        -command "start_process_pgf" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but47" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -command "upload_pgf" \
        -compound left -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -text "Upload" 
...
### SPOT dump_widget_opt A
    ...
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button "$site_3_0.tBu73" \
        -command "start_process_jpg" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but48" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -command "upload_jpg" \
        -compound left -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -text "Upload" 
...
### SPOT dump_widget_opt A
    ...
    labelframe "$top.lab91" \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -text "Stitch 360low" -background $vTcl(actual_gui_bg) -height 119 \
        -highlightcolor black -width 686 
...
### SPOT dump_widget_opt A
    ...
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button "$site_3_0.tBu73" \
        -command "start_stitch_360low" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but47" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 \
        -command "upload_360low" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text "Upload" 
...
### SPOT dump_widget_opt A
    labelframe "$top.lab46" \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -text "Stitch 360high" -background $vTcl(actual_gui_bg) -height 136 \
...
### SPOT dump_widget_opt A
    entry "$site_3_0.ent49" \
        ...
        -selectforeground black -width 436 
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$site_3_0.tBu50" \
        -command "select_template" -takefocus {} -text "Select" \
        -compound left 
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$site_3_0.tBu47" \
        -command "start_stitch_360high" -takefocus {} -text "Start" \
        -compound left 
...
### SPOT dump_widget_opt A
    button "$site_3_0.but47" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 \
        -command "upload_360high" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text "Upload" 
...
proc vTclWindow.top2 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 361x750+1260+44
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab47" \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -text "Recordings" -background $vTcl(actual_gui_bg) -height 355 \
...
proc vTclWindow.top3 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 370x422+134+261
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    labelframe "$top.lab53" \
        -font "TkDefaultFont" -foreground $vTcl(actual_gui_fg) \
        -text "Projects" -background $vTcl(actual_gui_bg) -height 344 \
        -highlightcolor black -width 337 
    vTcl:DefineAlias "$top.lab53" "projects" vTcl:WidgetProc "project" 1
### SPOT dump_widget_opt A
    button "$top.but54" \
        -activebackground $vTcl(analog_color_m) -activeforeground black \
        -background $vTcl(actual_gui_bg) -borderwidth 2 \
        -command "close_select_prj" -compound left -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text "Select" 
