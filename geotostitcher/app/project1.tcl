...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 684x831+685+57
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ::vTcl::widgets::ttk::labelframe::createCmd "$top.tLa51" \
        -text "Configs" -width 684 -height 135 
    ...
    labelframe "$top.lab52" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Pre Process" -background #d9d9d9 -height 72 -width 647 
    ...
    labelframe "$top.lab53" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Process PGF" -background #d9d9d9 -height 109 -width 647 
    ...
    labelframe "$top.lab91" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Generate Tiles" -background #d9d9d9 -height 100 -width 647 
    ...
    labelframe "$top.lab46" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Stitch 360high" -background #d9d9d9 -height 156 -width 647 
    ...
    place $site_3_0.ent57 \
        -in $site_3_0 -x 0 -relx 0.201 -y 0 -rely 0.342 -width 406 \
        -relwidth 0 -height 26 -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.lab52 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.16 -width 0 -relwidth 0.946 \
        -height 0 -relheight 0.081 -anchor nw -bordermode ignore 
    place $top.lab53 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.249 -width 0 -relwidth 0.946 \
        -height 0 -relheight 0.123 -anchor nw -bordermode ignore 
    place $top.lab90 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.385 -width 0 -relwidth 0.944 \
        -height 0 -relheight 0.115 -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.509 -width 0 -relwidth 0.944 \
        -height 0 -relheight 0.128 -anchor nw -bordermode ignore 
    place $top.lab91 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.826 -width 0 -relwidth 0.946 \
    ...
    place $top.tBu62 \
        ...
        -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 0 -relx 0.029 -y 0 -rely 0.645 -width 0 -relwidth 0.946 \
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -background #d9d9d9 
    wm focusmodel $top passive
    wm geometry $top 1234x865+321+130
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab47" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Recordings" -background #d9d9d9 -height 793 -width 1171 
    ...
    ###################
    place $top.lab47 \
        -in $top -x 0 -relx 0.025 -y 0 -rely 0.012 -width 0 -relwidth 0.949 \
        -height 0 -relheight 0.917 -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 0 -relx 0.462 -y 0 -rely 0.948 -width 89 -relwidth 0 \
