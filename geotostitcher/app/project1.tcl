...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 684x826+645+64
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab52" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Pre Process" -background #d9d9d9 -height 80 -width 686 
    ...
    labelframe "$top.lab53" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Process PGF" -background #d9d9d9 -height 110 -width 686 
    ...
    labelframe "$top.lab91" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Generate Tiles" -background #d9d9d9 -height 102 -width 647 
    ...
    labelframe "$top.lab90" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Process JPG" -background #d9d9d9 -height 120 -width 686 
    ...
    labelframe "$top.lab46" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Stitch 360high" -background #d9d9d9 -height 117 -width 647 
    ...
    place $site_3_0.ent49 \
        -in $site_3_0 -x 0 -relx 0.201 -y 0 -rely 0.222 -width 406 \
    ...
    place $top.lab52 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.159 -width 0 -relwidth 0.945 \
        -height 0 -relheight 0.092 -anchor nw -bordermode ignore 
    place $top.lab53 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.258 -width 0 -relwidth 0.945 \
        -height 0 -relheight 0.112 -anchor nw -bordermode ignore 
    place $top.tBu92 \
        -in $top -x 0 -relx 0.409 -y 0 -rely 0.944 -width 80 -relwidth 0 \
        -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tBu62 \
        -in $top -x 0 -relx 0.848 -y 0 -rely 0.944 -width 80 -relwidth 0 \
        -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab91 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.808 -width 0 -relwidth 0.946 \
        -height 0 -relheight 0.121 -anchor nw -bordermode ignore 
    place $top.lab90 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.381 -width 0 -relwidth 0.945 \
        -height 0 -relheight 0.127 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.655 -width 0 -relwidth 0.946 \
        -height 0 -relheight 0.142 -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.518 -width 0 -relwidth 0.945 \
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -background #d9d9d9 
    wm focusmodel $top passive
    wm geometry $top 361x750+1436+129
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab47" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Recordings" -background #d9d9d9 -height 355 -width 550 
