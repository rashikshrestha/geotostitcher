...
#  Oct 15, 2022 04:39:08 PM +0545  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 726x750+682+134
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $top.lab52 \
        -in $top -x 0 -relx 0.028 -y 0 -rely 0.227 -width 0 -relwidth 0.945 \
    ...
    place $top.tBu62 \
        -in $top -x 0 -relx 0.854 -y 0 -rely 0.92 -width 80 -relwidth 0 \
        -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab90 \
...
proc vTclWindow.top2 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 600x431+768+466
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
