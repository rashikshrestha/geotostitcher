...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 684x888+580+884
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::button "$site_3_0.tBu51" \
        -command "start_top_process" -text "Top Process" -compound left 
    vTcl:DefineAlias "$site_3_0.tBu51" "start_top_process" vTcl:WidgetProc "geoto_stitcher" 1
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::style map TButton -background  [list disabled #d9d9d9 !disabled #d9d9d9]
    ttk::button "$site_3_0.tBu52" \
        -command "start_bottom_process" -text "Bottom Process" -compound left 
    vTcl:DefineAlias "$site_3_0.tBu52" "start_bottom_process" vTcl:WidgetProc "geoto_stitcher" 1
    place $site_3_0.tBu61 \
        -in $site_3_0 -x 0 -relx 0.073 -y 0 -rely 0.345 -width 80 -relwidth 0 \
        -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tBu51 \
        -in $site_3_0 -x 0 -relx 0.587 -y 0 -rely 0.317 -width 100 \
        -relwidth 0 -height 31 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tBu52 \
        -in $site_3_0 -x 0 -relx 0.773 -y 0 -rely 0.317 -width 120 \
        -relwidth 0 -height 31 -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
...
proc vTclWindow.top3 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 1019x938+196+913
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab53" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Projects" -background #d9d9d9 -height 876 -width 983 
    vTcl:DefineAlias "$top.lab53" "projects" vTcl:WidgetProc "project" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but54 \
        -in $top -x 0 -relx 0.461 -y 0 -rely 0.957 -width 73 -relwidth 0 \
        -height 33 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab53 \
        -in $top -x 0 -relx 0.02 -y 0 -rely 0.011 -width 0 -relwidth 0.965 \
        -height 0 -relheight 0.934 -anchor nw -bordermode ignore 
