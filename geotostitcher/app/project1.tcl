...
#  Apr 19, 2024 02:09:10 PM +0545  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 684x888+559+75
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    radiobutton "$site_3_0.rad50" \
        ...
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -justify left -selectcolor #d9d9d9 -text "s21" -value "3" \
        -variable "selectedButton" 
    ...
    place $site_3_0.rad50 \
        -in $site_3_0 -x 0 -relx 0.132 -y 0 -rely 0.434 -width 0 \
        -relwidth 0.098 -height 0 -relheight 0.17 -anchor nw \
        -bordermode ignore 
