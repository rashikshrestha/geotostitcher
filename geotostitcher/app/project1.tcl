...
proc vTclWindow.top3 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 370x901+196+913
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe "$top.lab53" \
        -font "-family {DejaVu Sans} -size 10" -foreground #000000 \
        -text "Projects" -background #d9d9d9 -height 823 -width 337 
    vTcl:DefineAlias "$top.lab53" "projects" vTcl:WidgetProc "project" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but54 \
        -in $top -x 0 -relx 0.378 -y 0 -rely 0.943 -width 73 -relwidth 0 \
        -height 33 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab53 \
        -in $top -x 0 -relx 0.051 -y 0 -rely 0.013 -width 0 -relwidth 0.911 \
